...
const PostCard = (props: {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <h1 className='transition duraion-700 text-center mb-8 cursor-pointer hover:text-pink-600 text-3xl font-semibold'>
      ...
      <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
        <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8 items-center">
          ...
          />
          <p className="inline align-middle text-gray-700 ml-2 font-medium text-lg">{props.post.author.name}</p>
        </div>
